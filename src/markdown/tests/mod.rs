//! Snapshot tests for the Phase-A + Phase-B + Phase-E Markdown pipeline.
//!
...
//! coverage, DMI normalization, prose EN/JA readability and wording)
//! surface as an isolated snapshot diff.
