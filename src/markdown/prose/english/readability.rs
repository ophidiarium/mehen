...
pub(crate) const IDENTIFIER_LEN_CAP: usize = 20;
...
pub(crate) struct ReadabilityReport {
    pub(crate) flesch_reading_ease: Option<f64>,
    pub(crate) flesch_kincaid_grade: Option<f64>,
    pub(crate) gunning_fog: Option<f64>,
    pub(crate) smog: Option<f64>,
    pub(crate) ari: Option<f64>,
    pub(crate) coleman_liau: Option<f64>,
    pub(crate) dale_chall_new: Option<f64>,
    pub(crate) dale_chall_list: String,
    pub(crate) forcast: Option<f64>,
    pub(crate) lix: Option<f64>,
    pub(crate) rix: Option<f64>,
    pub(crate) ensemble_grade_band: [Option<f64>; 2],
}

/// Returns an all-null report for inputs below the short-doc threshold.
pub(crate) fn short_doc_report(_lex: &EnglishLexical) -> ReadabilityReport {
    ReadabilityReport {
...
pub(crate) fn analyze(sents: &[String], words_per_sent: &[Vec<String>]) -> ReadabilityReport {
