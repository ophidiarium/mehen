...
pub(crate) struct InclusiveReport {
    pub(crate) flags: Vec<Flag>,
    pub(crate) inclusive_language_score: f64,
    /// Total distinct surfaces flagged.
    pub(crate) flag_count: u64,
}
...
pub(crate) fn analyze(_words: &[String], raw_text: &str) -> InclusiveReport {
