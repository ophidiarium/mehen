...
pub(crate) struct EnglishLexical {
    pub(crate) mattr_50: f64,
    pub(crate) hapax_ratio: f64,
    pub(crate) dis_ratio: f64,
    pub(crate) lexical_density: f64,
    pub(crate) avg_sentence_words: f64,
    pub(crate) p90_sentence_words: u64,
    pub(crate) max_sentence_words: u64,
    pub(crate) stddev_sentence_words: f64,
    pub(crate) avg_word_chars: f64,
    pub(crate) p90_word_chars: u64,
    pub(crate) sentence_count: u64,
    pub(crate) words_total: u64,
}
...
pub(crate) fn analyze(words_per_sent: &[Vec<String>], words_flat: &[String]) -> EnglishLexical {
