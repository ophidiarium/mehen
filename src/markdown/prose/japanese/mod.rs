...
pub(crate) mod jouyou;
pub(crate) mod jtf;
pub(crate) mod scripts;
pub(crate) mod sentences;
pub(crate) mod tateishi;
pub(crate) mod wording;

use serde::Serialize;

pub(crate) use self::jtf::JtfReport;
pub(crate) use self::scripts::ScriptComposition;
pub(crate) use self::wording::{JapaneseLexical, JapaneseWording};

#[derive(Debug, Clone, Serialize, Default)]
pub(crate) struct JapaneseReport {
    pub(crate) script_composition: ScriptComposition,
    pub(crate) readability: JapaneseReadability,
    pub(crate) lexical: JapaneseLexical,
    pub(crate) wording: JapaneseWording,
    pub(crate) style_conformance: JtfReport,
    pub(crate) short_doc_warning: bool,
}

#[derive(Debug, Clone, Serialize, Default)]
pub(crate) struct JapaneseReadability {
    pub(crate) tateishi_rs: Option<f64>,
    pub(crate) jouyou_grade_mean: Option<f64>,
    pub(crate) hyougai_ratio: f64,
}

pub(crate) fn analyze(text: &str) -> JapaneseReport {
