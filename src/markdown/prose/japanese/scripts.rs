...
pub(crate) struct ScriptComposition {
    pub(crate) kanji_ratio: f64,
    pub(crate) hiragana_ratio: f64,
    pub(crate) katakana_ratio: f64,
    pub(crate) latin_ratio: f64,
    pub(crate) digit_ratio: f64,
    pub(crate) script_entropy: f64,
    pub(crate) visible_chars: u64,
}
...
pub(crate) fn analyze(text: &str) -> (ScriptComposition, Vec<Run>) {
    let mut hira = 0u64;
    let mut kata = 0u64;
    let mut han = 0u64;
    let mut lat = 0u64;
