...
pub struct JapaneseLexical {
    pub avg_sentence_chars: f64,
    pub p90_sentence_chars: u64,
    pub max_sentence_chars: u64,
    pub comma_period_ratio: f64,
    pub jukugo_density: f64,
    pub sentence_count: u64,
    pub char_count: u64,
}

#[derive(Debug, Clone, Serialize, Default)]
pub struct JapaneseWording {
    pub politeness_dominant: String,
    pub keitai_count: u64,
    pub jotai_count: u64,
    pub honorific_count: u64,
    pub keitai_jotai_mix_count: u64,
    pub weak_phrase_count: u64,
    pub redundant_expression_count: u64,
    pub doubled_joshi_count: u64,
    pub long_kanji_run_count: u64,
    pub max_comma_violation_count: u64,
    pub max_ten_violation_count: u64,
    pub long_sentence_count: u64,
    pub wording_quality_score: f64,
}
