...
across a repository. It tracks complexity, maintainability, size, and documentation health, and is built
for CI runs, pre-PR hooks, and pull request automation.
...
<Columns cols={2}>
  ...
  <Card title="Quickstart" icon="rocket" href="/quickstart">
    Run your first analysis and read the output in under a minute.
  </Card>
...
<Columns cols={2}>
  <Card title="Polyglot by design" icon="layer-group">
    Per-file language detection across nine source languages plus Markdown — useful for monorepos.
  </Card>
  ...
  <Card title="Many output formats" icon="file-export">
    Console, JSON, YAML, TOML, CBOR, GitHub-flavored Markdown.
  </Card>
  <Card title="Built on tree-sitter" icon="tree">
    Same incremental parsers used by editors — fast, robust, syntax-aware.
  </Card>
</Columns>
...
<Steps>
  ...
  <Step title="Run your first analysis">
    Compute metrics for any directory:
