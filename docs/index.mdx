...
languages plus Markdown, runs in a few seconds even on large monorepos, and ships a GitHub Action that
...
<Columns cols={2}>
  <Card title="Polyglot, per-file" icon="layer-group">
    Per-file language detection across nine languages plus Markdown. Built for monorepos.
  </Card>
...
In the Ophidiarium projects, names matter. **Mehen** is a mythical ancient Egyptian serpent associated
