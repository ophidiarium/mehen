...
| `loc` | — | Alias for `loc.sloc`, retained for legacy compatibility. |
...
- NIST: [Lines of Code](https://www.nist.gov/itl/ssd/software-assurance-metrics-and-tool-evaluation-samate)
  (background and pitfalls).
- Sonar: [Metrics definitions — lines](https://docs.sonarsource.com/sonarqube-server/latest/user-guide/code-metrics/metrics-definition/).
