...
The normative reference for derivations and citation graph is
[`design-docs/mehen_markdown_metrics_research_foundation.md`](https://github.com/ophidiarium/mehen/blob/main/design-docs/mehen_markdown_metrics_research_foundation.md).
Each metric page below cites the corresponding `(§N.N)` section so you can find the source derivation.
