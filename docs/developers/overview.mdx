...
- For tree-sitter grammar regeneration: a Linux or macOS shell (or Windows via WSL).
...
| `crates/mehen-<lang>` | Per-language analyzers (one crate per language). |
...
| `crates/mehen-report` | JSON and GitHub-Markdown rendering. |
